...
public partial class EvaluasiNyeriBayi
{
    [Key]
    [StringLength(15)]
    [Unicode(false)]
    ...
    [StringLength(100)]
    [Unicode(false)]
    public string? KebutuhanValue { get; set; }

    [StringLength(100)]
    [Unicode(false)]
    public string? PeningkatanValue { get; set; }

    [StringLength(100)]
    [Unicode(false)]
    public string? EkspresiWajahValue { get; set; }

    [StringLength(100)]
    [Unicode(false)]
    public string? TidurValue { get; set; }

    [StringLength(10)]
    [Unicode(false)]
    public string? NyeriBayiValue { get; set; }

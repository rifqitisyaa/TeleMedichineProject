...
public partial class RL1BayiTabung
{
    [Key]
    [StringLength(10)]
    [Unicode(false)]
    ...
    public int SiklusPengobatan { get; set; }

    public int Kehamilan { get; set; }

    public int TakeHomeBaby { get; set; }

...
public partial class DW_FactFIFOInPeriode
{
    [Key]
    ...
    [ForeignKey("DateID")]
    [InverseProperty("DW_FactFIFOInPeriodeDate")]
    public virtual DW_DimDate Date { get; set; } = null!;

    [ForeignKey("ItemID")]
    [InverseProperty("DW_FactFIFOInPeriode")]
    ...
    [InverseProperty("DW_FactFIFOInPeriodeTransactionDate")]

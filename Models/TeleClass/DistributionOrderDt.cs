...
public partial class DistributionOrderDt
{
    [Key]
    [StringLength(20)]
    [Unicode(false)]
    ...
    [InverseProperty("DistributionOrderDt")]
    public virtual DistributionOrderHd DistributionOrderNoNavigation { get; set; } = null!;

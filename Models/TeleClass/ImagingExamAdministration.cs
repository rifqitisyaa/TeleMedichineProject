...
public partial class ImagingExamAdministration
{
    [Key]
    [StringLength(20)]
    [Unicode(false)]
    ...
    [InverseProperty("ImagingExamAdministration")]
    public virtual JobOrderBOMImaging JobOrderBOMImaging { get; set; } = null!;
}

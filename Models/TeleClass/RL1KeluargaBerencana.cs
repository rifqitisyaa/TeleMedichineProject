...
public partial class RL1KeluargaBerencana
{
    [Key]
    [StringLength(10)]
    [Unicode(false)]
    ...
    public int RujukanRI { get; set; }

    public int RujukanRJ { get; set; }

    public int KunjunganUlang { get; set; }

    public int JumlahKeluhan { get; set; }
    ...
    [InverseProperty("RL1KeluargaBerencana")]

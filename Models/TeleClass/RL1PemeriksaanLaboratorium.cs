...
public partial class RL1PemeriksaanLaboratorium
{
    [Key]
    [StringLength(10)]
    [Unicode(false)]
    ...
    public int Sederhana { get; set; }

    public int Sedang { get; set; }

    public int Canggih { get; set; }

    public int Skrining { get; set; }

    public int Konfirmasi { get; set; }
    ...
    [InverseProperty("RL1PemeriksaanLaboratorium")]

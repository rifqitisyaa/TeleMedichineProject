...
[Keyless]
public partial class RekapDataHarianPasienDirawatTanpaKomorBid
{
    ...
    public int? JmlICUTTNDV { get; set; }
    ...
    public int? JmlICUTTNTV { get; set; }

...
public partial class DW_FactFEFOInPeriode
{
    [Key]
    ...
    [ForeignKey("DateID")]
    [InverseProperty("DW_FactFEFOInPeriodeDate")]
    public virtual DW_DimDate Date { get; set; } = null!;

    [ForeignKey("ItemID")]
    [InverseProperty("DW_FactFEFOInPeriode")]
    ...
    [InverseProperty("DW_FactFEFOInPeriodeTransactionDate")]
    public virtual DW_DimDate TransactionDate { get; set; } = null!;

    [ForeignKey("TransactionDateTimeID")]
    [InverseProperty("DW_FactFEFOInPeriode")]
    public virtual DW_DimTime? TransactionDateTime { get; set; }
}

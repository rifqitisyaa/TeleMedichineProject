...
public partial class RL1KegiatanFarmasi
{
    [Key]
    [StringLength(10)]
    [Unicode(false)]
    ...
    public int JumlahObatRS { get; set; }

    public int JumlahObatFormulariumRS { get; set; }

    public int RawatJalan { get; set; }

    public int UGD { get; set; }

    public int RawatInap { get; set; }

    public int TotalR { get; set; }

    public int TotalLayanR { get; set; }
    ...
    [InverseProperty("RL1KegiatanFarmasi")]

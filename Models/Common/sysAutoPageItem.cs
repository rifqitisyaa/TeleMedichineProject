...
[PrimaryKey("EntityClassName", "FieldName")]
public partial class sysAutoPageItem
{
    [Key]
    [StringLength(50)]
    [Unicode(false)]
    ...
    /// <summary>
    /// Diisi bila Field disusun dari beberapa field (Composite Field)
    /// </summary>
    [StringLength(500)]
    [Unicode(false)]
    ...
    /// <summary>
    /// Diisi nama field bila nama alias berbeda dgn nama field
    /// </summary>
    [StringLength(50)]
    [Unicode(false)]
